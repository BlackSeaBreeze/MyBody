...
- Для пользователя переводи в МИНУТЫ (целые, округление математически): «глубокий сон 45 мин», «REM 98 мин».
- Общая длительность сна допустима как «7 ч 05 мин» или «425 мин» — но не «25500 сек».
- Пример: deepSleepSeconds=2700 → 45 мин; remSleepSeconds=5880 → 98 мин.
- В garmin_key_points, executive_summary, секции sleep — только минуты (и ч+мин для полного сна), никогда «N сек».
"""
