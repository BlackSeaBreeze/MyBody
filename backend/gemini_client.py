...
Одна прошедшая ночь: фазы (>60 мин → ч:мм, иначе «N мин»), качество, пробуждения, HRV/стресс сна — только цифры за эту ночь.
### Активность (D−1)
...
## watch_out
2–4 пункта «на что обратить внимание» — только **питание, активность, сон и восстановление** (Garmin + рацион).
Не включай сюда клинические/лабораторные риски, хронические диагнозы и отклонения из medical_data —
их контекст только в medical_key_points и cross_domain_insights.
Примеры: дефицит клетчатки/белка, перегруз, поздний ужин, мало шагов, недовосстановление.
Каждая строка: **[bad]** или **[warn]** + жирная метка.

## tomorrow_focus
Одно предложение — главный actionable фокус на завтра (питание, активность, режим).
Формат: [priority: high|medium|low] **[good|warn] Метка:** текст. Теги нужны для оформления email.
...
- Не ставь медицинских диагнозов.
- Стресс Garmin = HRV-метрика, не психология.
- Длительность сна: >60 мин → ч:мм (7:05); ≤60 мин → «N мин»; не секунды.
